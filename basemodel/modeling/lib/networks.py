...
from hjk.segment_anything.modeling.maxxvit_4out import maxvit_tiny_rw_224 as maxvit_tiny_rw_224_4out
from hjk.segment_anything.modeling.maxxvit_4out import maxvit_rmlp_tiny_rw_256 as maxvit_rmlp_tiny_rw_256_4out
from hjk.segment_anything.modeling.maxxvit_4out import maxxvit_rmlp_small_rw_256 as maxxvit_rmlp_small_rw_256_4out
from hjk.segment_anything.modeling.maxxvit_4out import maxvit_rmlp_small_rw_224 as maxvit_rmlp_small_rw_224_4out
...
class MERIT_Cascaded_Small(nn.Module):
    def __init__(self, n_class=1, img_size_s1=(256,256), img_size_s2=(224,224), decoder_aggregation='additive', interpolation='bilinear'):
        ...
        # backbone network initialization with pretrained weight
        self.backbone1 = maxvit_tiny_rw_224_4out()  # [64, 128, 320, 512]
        self.backbone2 = maxvit_tiny_rw_224_4out()  # [64, 128, 320, 512]
        state_dict1 = torch.load('/root/autodl-tmp/H-SAM_new/segment_anything/modeling/lib/maxvit_tiny_rw_224_sw-7d0dffeb.pth')        
        self.backbone1.load_state_dict(state_dict1, strict=False)
