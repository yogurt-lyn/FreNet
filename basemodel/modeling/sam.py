...
class Sam(nn.Module):
    ...
    def forward(self, batched_input, multimask_output, mode='train'):
        ...
        outputs = self.forward_train(batched_input, multimask_output,mode=mode)
            
        return outputs

    def forward_train(self, batched_input, multimask_output,input_points=None, mode='train'):
        ...
        low_res_masks_1, _, = self.mask_decoder(
