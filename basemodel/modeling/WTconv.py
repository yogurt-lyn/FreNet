...
class WTConv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=5, stride=1, dilation=1, bias=True, wt_levels=1, wt_type='db1'):
        ...
        self.wavelet_convs = nn.ModuleList(
            [nn.Conv2d(in_channels*4, in_channels*4, kernel_size, padding='same', stride=1, dilation=self.dilation, groups=in_channels*4, bias=False) for _ in range(self.wt_levels)]
        )
